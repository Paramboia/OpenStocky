...
export function PortfolioHeader() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Primary KPIs + Performance Metrics Side by Side */}
      <div className="grid gap-4 grid-cols-1 xl:grid-cols-3">
        {/* Left: Primary KPI Cards */}
        <div className="xl:col-span-2 grid gap-4 grid-cols-1 sm:grid-cols-2">
        ...
        <Card className="bg-card border-border h-full">
          ...
          <CardContent>
            <div className="grid gap-4 grid-cols-2 sm:grid-cols-4 xl:grid-cols-2">
              ...
              <KpiTooltip content="Risk-adjusted return relative to volatility. Higher is better. Above 1 is good, above 2 is excellent">
                <div className="space-y-1 cursor-help">
                  <p className="text-xs text-muted-foreground flex items-center gap-1">
                    <Scale className="h-3 w-3" /> Sharpe Ratio
                  </p>
      ...
      {/* Portfolio Composition - Single Line */}
